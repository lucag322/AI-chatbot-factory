  ...
  return (
    <div className="container mx-auto h-full flex flex-col justify-center items-center">
      ...
      <div className="flex gap-4">
        <Link
          href="/chatbots"
          className="bg-primary text-primary-foreground hover:bg-primary/90 py-3 px-6 rounded-sm transition-colors"
        >
          Gérer mes chatbots
        </Link>
        <Link
          href="/chatbots/new"
          className="bg-accent text-accent-foreground hover:bg-accent/90 py-3 px-6 rounded-sm transition-colors"
        >
